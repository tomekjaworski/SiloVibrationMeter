...
#define ENC_WriteRegister_MACRO(__RA, __VAL) { CS_ENC = 0; dummy = SPI2BUF;	SPI_SEND_AND_WAIT(WRITE_CONTROL_REGISTER | (__RA));	dummy = SPI2BUF; SPI_SEND_AND_WAIT((__VAL)); CS_ENC = 1;};
